...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((((class color) (min-colors 88) (background dark)) (:foreground "#4f97d7" :weight bold))))
   ...
   `(ivy-minibuffer-match-face-2 ((t (:background "SpringGreen2" :weight bold :foreground "MidnightBlue"))))
   `(ivy-minibuffer-match-face-3 ((t (:background "SpringGreen3" :weight bold :foreground "MidnightBlue"))))
   `(ivy-minibuffer-match-face-4 ((t (:background "SpringGreen4" :weight bold :foreground "MidnightBlue"))))
   ...
   `(mode-line ((t (:box (:line-width 2 :color "#315068" :style released-button) :inverse-video nil :background "#315068"))))
   ...
   `(org-level-1 ((t (:foreground "#14d1cd" :height 1.2 :weight bold))))
   ...
   `(org-todo ((t (:foreground "#b2113c" :weight bold))))
   ...
   `(org-special-keyword ((t (:foreground "#fff200" :weight bold))))
   ...
   `(web-mode-html-tag-face ((t (:foreground "RosyBrown"))))
   `(web-mode-html-tag-bracket-face ((t (:foreground "RosyBrown"))))
