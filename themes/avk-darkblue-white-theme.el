...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(org-level-1 ((t (:foreground "#14d1cd" :height 2.0 :weight bold :family "Andada"))))
   `(org-level-2 ((t (:foreground "#14d169" :weight bold :height 1.2))))
   `(org-level-3 ((t (:foreground "#e59dea" :weight bold :height 1.2))))
   `(org-level-4 ((t (:foreground "yellow" :weight bold :height 1.2))))
