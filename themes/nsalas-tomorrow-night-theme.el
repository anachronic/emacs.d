...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   `(org-date ((t (:foreground "DimGrey" :underline t))))
   `(org-document-title ((t (:foreground "LightPink" :weight bold))))
   ...
   `(org-level-1 ((t (:foreground "SpringGreen3"))))
   `(org-level-2 ((t (:foreground "#c58fe0"))))
   `(org-level-3 ((t (:foreground "#e59dea"))))
   `(org-level-4 ((t (:foreground "LightCoral"))))
   ...
   `(org-special-keyword ((t (:foreground "DimGrey"))))
